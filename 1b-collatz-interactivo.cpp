 ...
 * Resumen: Programa interactivo y de una sola función main() que pide al
 *          usuario un número natural y escribe en la pantalla la secuencia de
 *          Collatz generada por dicho número.
